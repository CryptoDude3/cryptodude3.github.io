...
document.addEventListener("keydown",(e)=>{if(e.key!==cheat.key.toLowerCase()){return;}console.log("called");const value = read8(addrs[cheat.addrValue]);set8(value?0:1,addrs[cheat.addrValue]);cheatElem.setValue(cheat.invert?!value:value);});
break;
}
});
