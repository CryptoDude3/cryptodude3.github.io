...
var wasmBinaryFile;
  wasmBinaryFile = 'bruteforce2.wasm';
...
function console_log_js(a){ const output = document.querySelector("#output"); let div = document.createElement("div"); div.innerText=UTF8ToString(a); output.appendChild(div); }
function prompt_int(a){ return parseInt(prompt(UTF8ToString(a))); }
...
/** @type {function(...*):?} */
var _generateLevel = Module["_generateLevel"] = createExportWrapper("generateLevel");
